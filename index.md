...
<head>
    ...
    <title>Bài Tập Web 2026 - Võ Trần Thiên Vũ</title>
    <style>
        /* PHẦN TRANG TRÍ (CSS) */
        body {
...
<body>
    ...
    <div class="container">
        <div class="student-info">
            Võ Trần Thiên Vũ - THK47SP
        </div>

        <h1>Xin chào! Đây là trang web đầu tiên của mình.</h1>
        
        <p class="subtitle">Mình đang học lộ trình Frontend theo roadmap.sh</p>

        <h2>Danh sách bài thực hành:</h2>
        <ul>
            <li><a href="Lab_01_TKWeb/index.html">Bài thực hành số 1 (Lab 1)</a></li>
       
            <li>
                <a href="Lab02_TKWeb/index.html">Bài thực hành số 2 (Lab 2)</a>
            </li>
            <li>
            ...
            <li>
                <a href="Lab_07_TKWeb/index.html">Bài thực hành số 7 (Lab 7)</a>
            </li>
             <li>
                <a href="Lab_08_TKWeb/index.html">Bài thực hành số 8 (Lab 8)</a>
            </li>
             <li>
                <a href="Lab_09_TKWeb/index.html">Bài thực hành số 9 (Lab 9)</a>
            </li>
            <li>
